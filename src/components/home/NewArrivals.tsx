        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4 md:gap-6">
          {featured.map((p, i) => (
            ...
            >
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden rounded-sm bg-card shadow-[0_0_40px_-12px_rgba(0,0,0,0.6)]">
                ...
                <div className="mt-4 flex items-start justify-between gap-2 sm:mt-5 sm:gap-3">
                  <div className="min-w-0">
                    <p className="truncate font-display text-[13px] font-medium uppercase tracking-wide text-foreground sm:text-sm">
                      {p.name}
                    </p>
                    <p className="mt-1 font-sans text-[11px] text-foreground/50 sm:text-xs">
                      {p.category}
                    </p>
                  </div>
                  <p className="shrink-0 font-sans text-xs font-medium text-foreground/70 sm:text-sm">
                    ${p.price}
                  </p>
                </div>
              </Link>
