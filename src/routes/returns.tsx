      ...
      blocks={[
        {
          ...
          body: [
            ...
            "The item needs to come back new, unused and in its original condition — brand tag and plastic seal still attached. Once either is removed, the piece is no longer eligible.",
        ...
        },
        {
          ...
          body: [
            ...
            "Once approved, pickup is attempted twice at your address. If both attempts fail, you'll need to ship the piece back to us yourself — reverse pickup depends on courier availability in your area.",
        ...
        },
        {
          ...
          body: [
            ...
            "Each order gets one return or exchange, not both, and not a second time. Double-check size and details before confirming — once an exchange is fulfilled, that order is closed.",
            "Exchanging into something cheaper doesn't generate a cash-back on the difference. If you'd rather keep that value, return the piece instead and take a gift card — it never expires.",
          ],
        },
        {
        ...
        },
        {
          ...
          body: ["Returns and exchanges aren't available outside India — please choose sizing and pieces carefully before ordering internationally."],
        },
      ]}
    />
  ),
